...
Page.BackgroundTransparency = 20
...
ttittles.Text = "PeruX Hub"
ttittles.TextSize = 17.000
ttittles.TextColor3 = Color3.fromRGB(255, 255, 0)
...
local plr = game:GetService("Players").LocalPlayer
    ...
    V:Textbox("Fake Fragment",true,function(value)
