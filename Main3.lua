...
local Setting = a:Tab("Tab Cài đặt")
local M = a:Tab("Tab Vật Phẩm")
local Ss = a:Tab("Tab Vũ Khí")
local RaceV4 = a:Tab("Tab Tộc V4")
local E = a:Tab("Tab Sự Kiện Biển")
local T = a:Tab("Tab Dịch Chuyển")
local P = a:Tab("Tab Người Chơi")
...
HomePage:Label("Blox Fruits | Script Version Premiums")
...
Main:Dropdown("Fast Attack Delay", AttackList,function(value)
...
if _G.ChestBypass then
    ...
    Main:Toggle("Triệu hồi tư lệnh bột",function(value)
...
--Item
    ...
    Ss:Toggle("Lấy Soul Guitar",_G.AutoNevaSoulGuitar,function(value)
...
Ss:Toggle("Lấy Soul Guitar + Đổi Sever",function(value)
  _G.soulGuitarhop = value    
 end)
 
 Ss:AddSeperator("Dual Curse Katana")

Ss:Toggle("Lấy Song Kiếm Oden",_G.AutoCdk,function(value)
...
spawn(function()
	...
	spawn(function()
 	...
 	Ss:Seperator(" Tushita ")

Ss:Toggle("Lấy Tushita", _G.Autotushita,function(value)
    ...
    Ss:Seperator("Carvander")

    Ss:Toggle("Lấy Kiếm Thợ Khắc", _G.AutoCarvender,function(value)
    ...
    Ss:Seperator("Pirate Raid")
    
    Ss:Toggle("Đánh Hải Tặc", _G.AutoRaidPirate,function(value)
...
spawn(function()
    ...
    Ss:Seperator("Twin Hook")
    
    Ss:Toggle("Lấy Song Móc", _G.AutoTwinHook,function(value)
    ...
    Ss:Seperator("Hallow Scythe")
    
    Ss:Toggle("Lấy Lưỡi Hái Bóng Tối",_G.AutoFarmBossHallow,function(value)
...
Ss:Toggle("Triệu Hồi Rip_Indra",function()
AutoHaki()
wait(0.5) 
local args = {
[1] = "activateColor",
...
HyperCahaya(CFrame.new(-5419.98095703125, 1093.3375244140625, -2666.730712890625))
    ...
    Ss:Seperator("Dark Dagger")
    
    Ss:Toggle("Đánh Boss Rip_indra",_G.AutoDarkDagger,function(value)
    ...
    Ss:Seperator(" Trident ")
	
	Ss:Toggle("Lấy Đinh Ba Rồng", _G.Auto_Dragon_Trident,function(value)
    ...
    Ss:AddToggle("Lấy Gậy Lôi V1", _G.Autodoughking,function(value)
         _G.Autopole = value
    ...
    Ss:Seperator("Misc Swan Glasses")
    
    Ss:Toggle("Đánh Swan",_G.AutoFarmSwanGlasses,function(value)
    ...
    Ss:Seperator("Sharks Saw")
    
    Ss:AddToggle("Lấy Saw", _G.Autodoughking,function(value)
         _G.Autosaw = value
        StopTween( _G.Autopole)
    end)
    ...
    spawn(function()
        ...
        Ss:Seperator("Observation")
    
    local ObservationRange = Ss:Label("")
    ...
    Ss:Toggle("Cày Điểm Haki",_G.AutoObservation,function(value)
    ...
    Ss:Toggle("Cày Điểm Haki Hop",_G.AutoObservation_Hop,function(value)
    ...
    Ss:Toggle("Lấy Saber",_G.AutoSaber,function(value)
				_G.AutoSaber = value
			end)
			
			Ss:Toggle("Lấy Saber + Đổi Sever",_G.AutoSaberHop,function(value)
 ...
 spawn(function()
    ...
    Ss:Seperator("Legendary Sword")
    
    Ss:Toggle("Mua Kiếm Huyền Thoại",_G.AutoBuyLegendarySword,function(value)
    ...
    Ss:Seperator("Enchancement Colour")
    
    Ss:Toggle("Mua Haki Màu",_G.AutoBuyEnchancementColour,function(value)
        _G.AutoBuyEnchancementColour = value
    end)
    
    Ss:Toggle("Mua Haki + Đổi Sever",_G.AutoBuyEnchancementColour_Hop,function(value)
...
E:Seperator("Frozen Dimension")

FrozenIsland = E:Label("")
spawn(function()
    pcall(function()
        while wait() do
            if game.Workspace._WorldOrigin.Locations:FindFirstChild('Frozen Dimension') then
                ...
                FrozenIsland:Set('🔴: Đảo băng chưa Xuất Hiện')
            end
        end
    end)
end)

E:Toggle("Duy Chuyển Đến Đảo băng", false, function(value)
...
E:Seperator("Kittsune")
E:Toggle("Tp đến đảo kitsune",false,function(v)
    _G.TweenToKitsune = v
end)
spawn(function()
    local kitsuneIsland
...
E:Toggle("Nhặt Hồn",false,function(v)
    _G.CollectAzure = v
end)
spawn(function()
    while wait() do
...
E:Seperator("Sự kiện biển")
E:Toggle("Đánh terorshark",false,function(v)
...
spawn(function()
 ...
 E:Toggle("Đánh Piranha",false,function(v)
    _G.farmpiranya = v
end)
spawn(function()
    while wait() do
 ...
 E:Toggle("Đánh cá",false,function(v)
    _G.AutoShark = v
end)
spawn(function()
    while wait() do
...
E:Toggle("Đánh cá Crew",false,function(v)
    _G.AutoFishCrew = v
end)
spawn(function()
    while wait() do
...
Mirragecheck = E:Label("")
E:Toggle("Đến đảo kì bí",_G.AutoMysticIsland,function(value)
    ...
    spawn(function()
        ...
        E:Seperator("Đến Npc bán trái vip", function()
            TweenNpc()
            end)
...
E:Toggle("Treo đảo kì bí",_G.dao,function(state)
if state then
    _G.dao = true
else
    _G.dao = false
...
E:Toggle("Đến bánh răng",_G.TweenMGear,function(value)
_G.TweenMGear = value
...
D:Button("Fake Fruit [Old]", function()
...
if World1 then
    O:Toggle("Cày Cấp Nhanh Từ lv1-300", false, function(value)
        _G.Farmfast = value
