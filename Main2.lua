...
--Item
Ss:Toggle("Lấy Soul Guitar",function(value)
...
Ss:Toggle("Đánh Hình nộm",function(value)
    _G.Namfon = value
    StopTween(_G.Namfon)
end)
...
Ss:Toggle("Tự động nhấn nút Haki",function(value)
...
Ss:Toggle("Đánh Rip_Indra",function(value)
...
Ss:Toggle("Tự Động Đánh Râu Trắng",function(value)
    _G.Autogay = value
...
Ss:Toggle("Đánh Swan",function(value)
...
Ss:Toggle("Lấy Mũ Ngự Lâm",function(value)
...
Ss:Toggle("Lấy Haki Màu",function(value)
...
Ss:Toggle("Tự Động Nâng Tộc V2",function(value)
...
Ss:Toggle("Nhiệm vụ Bartilo",function(value)
...
Ss:Toggle("Tự Động Cấm Đuốt",function(value)
...
Ss:Seperator("Lengedary Sword")

LegendSwords = Ss:Label("")
spawn(function()
    pcall(function()
        while wait() do
...
Ss:Toggle("Mua Kiếm Huyền Thoại",function(value)
...
Ss:Toggle("Mua Haki Màu",function(value)
